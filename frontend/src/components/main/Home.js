  ...
  return (
    <>
      <>
          ...
          <div className="row">
            <div className="course-col">
              ...
              <p>
                ...
                or service hits the marketplace and gets feedback from the consumers.cd 
            ...
            <SwiperSlide>
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="img">
                    <img className='d-block m-auto' src="/Images/javed1.png" alt="img" draggable="false" />
                  </div>
        ...
        <footer> <small>Copyright © 2025 Awesome Influensers . All Rights Reserved.</small></footer>
      </>
